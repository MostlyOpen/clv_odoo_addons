...
class MedicamentForm(models.Model):
    ...
    active = fields.Boolean('Active',
                            ...
                            default=1)
    parent_id = fields.Many2one('clv_medicament.form', 'Parent Form', select=True, ondelete='restrict')
    complete_name = fields.Char(string='Full Medicament Form', compute='_name_get_fnc', store=False, readonly=True)
    child_ids = fields.One2many('clv_medicament.form', 'parent_id', 'Child Forms')
