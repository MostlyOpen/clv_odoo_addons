...
class Community(models.Model):
    ...
    name = fields.Char('Community', required=True, size=128, translate=False)
    alias = fields.Char('Alias', size=128, help='Common name that the Community is referred')
    ...
    comm_location = fields.Char('Community Location', size=128)
